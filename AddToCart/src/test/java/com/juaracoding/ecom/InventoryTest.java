...
public class InventoryTest {
    ...
    @Test
    public void addToCartFunctionalityTest() throws InterruptedException {
        DriverManager driverManager = new DriverManager();
        WebDriver driver = driverManager.getDriver();
        driver.get("https://www.saucedemo.com/v1/index.html");
        ...
        driver.findElement(InventoryRepository.addToCartButton).click();
        
        Thread.sleep(3000);

        String cartCount = driver.findElement(InventoryRepository.cartBadge).getText();
        Assert.assertEquals(cartCount, "1", "Ikon keranjang harus menunjukkan 1 item");

        String buttonText = driver.findElement(InventoryRepository.addToCartButton).getText();
