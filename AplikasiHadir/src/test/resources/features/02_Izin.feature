...
#     And user klik icon calender, input tanggal "9"
...
#     And user mengisi data : tanggal "9", jam 7 menit 30, keterangan "inputfield"
...
#     And pengguna memasukkan data : tanggal "9", jam 9 menit 30, keterangan "acarakeluarga"
...
#     And pengguna input data : Tanggal "9", jam 10 menit 30, keterangan "motor rusak"
...
Scenario: Negative Tombol Reset di Izin Pulang Cepat, Tanggal tidak benar2 kosong
    ...
    And Pengguna menginput data berupa : catatan "asdgasdgasd", tanggal "9", jam 3 menit 25.
    Then Pengguna menekan tombol reset, tanggal tidak kosong


# Scenario: Negative Tombol Reset di Izin Terlambat, Tanggal tidak benar2 kosong