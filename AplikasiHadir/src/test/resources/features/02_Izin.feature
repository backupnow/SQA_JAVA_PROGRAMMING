...
#     And user klik icon calender, input tanggal "10"
...
#     And user mengisi data : tanggal "10", jam 7 menit 30, keterangan "inputfield"
...
#     And pengguna memasukkan data : tanggal "10", jam 9 menit 30, keterangan "acarakeluarga"
...
#     And pengguna input data : Tanggal "10", jam 10 menit 30, keterangan "motor rusak"
...
#     And Pengguna menginput data berupa : tgl "10", jam 5 menit 20, keterangan "qwertytre".
...
#     And Pengguna mengisi data berupa : tgl "11", jam 4 menit 45, keterangan "qwertytre".
