Feature: Correction Feature
  ...
  Scenario Outline: Positive Ajukan Koreksi in Aplikasi Hadir
    ...
    And user menekan tombol jam masuk dan memasukkan data pada jam 9 menit 30 tanggal "26" bulan "September" tahun "2025".
    And user menekan tombol jam keluar dan memasukkan data pada jam 16 menit 00 tanggal "26" bulan "September" tahun "2025".
  ...
  #     |        8 |         30 |           |             |      26 | September |  2025 | Lengkapi data terlebih dahulu! |
  #     |          |            |        17 |          00 |      26 | September |  2025 | Lengkapi data terlebih dahulu! |
  #     |          |            |           |             |      26 | September |  2025 | Salah satu harus diisi!        |
  #     |       17 |         00 |         8 |          30 |      26 | September |  2025 | Isi data data dengan benar!    |
  ...
  #   When user menekan tombol ajukan koreksi.
  #   And user menekan ikon jam masuk dan menginput data jam 8 menit 30 untuk tanggal "26" bulan "September" tahun "2025".
  #   And user menekan ikon jam keluar dan menginput data jam 17 menit 00 untuk tanggal "26" bulan "September" tahun "2025".
