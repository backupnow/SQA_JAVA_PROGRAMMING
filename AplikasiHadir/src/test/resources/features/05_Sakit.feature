Feature: Manajemen Sakit
  ...
  Scenario: Navigation to halaman sakit in Aplikasi Hadir
    ...
    Scenario: Pengajuan sakit berhasil
        ...
        When user memilih tanggal mulai sakit "13"
        And user memilih tanggal selesai sakit "16"
    ...
    And pengguna memilih tanggal mulai sakit "13"
    And pengguna memilih tanggal selesai sakit "16"
    ...
    Scenario: User melakukan reset di form pengajuan sakit
      ...
      And user memilih tanggal mulai "13" dan tanggal akhir "16"
