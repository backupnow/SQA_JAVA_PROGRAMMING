...
public class AuthProviders {
  ...
  public void preConInputFormIzin(String date, int jam, int menit, String comment) throws InterruptedException {
  ...
  public void preCondInputDataIzin(String date, int jam, int menit, String comment) throws InterruptedException {
    izinpage().clickIconCalender();
    izinpage().inputTanggal(date);
    Thread.sleep(1000);
    izinpage().clickIconJam();
    dragnDrop().pilihJam(jam, menit);
    izinpage().inputKeterangan(comment);
  ...
  public void preConAjukanIzin() throws InterruptedException {
    preConditionLogin();
